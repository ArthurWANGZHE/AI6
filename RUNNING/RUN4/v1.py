...
# 生成文本
def generate_text(prompt, max_length=200, temperature=0.6):
...
loss_list = []
epoch_count = 1
initial_prompt = "小明来到一座山山上有座庙"

for epoch in range(num_epochs):
    generator.train()
    total_loss = 0

    with tqdm(4096 // batch_size) as pbar:
    ...
    generated_text = generate_text(initial_prompt, max_length=200, temperature=0.8)
...
generator.load_state_dict(torch.load('model_final_1.pth', map_location=torch.device('cpu')))
generator.eval()
