...
# 读取数据
with open('../book0.txt', 'r', encoding='utf-8') as file:
    text = file.read()
...
for epoch in range(num_epochs):
    ...
    with tqdm(320000 // batch_size) as pbar:
        for i in range(0, 320000, batch_size):
...
# 保存模型
torch.save(generator.state_dict(), f'model_final.pth')
